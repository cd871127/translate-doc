...
你将会在下面看到一些如何执行普通任务的信息。<br>
在[这里](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md)可以找到这个手册的最新版本。

## 目录

- [升级到新版本](#updating-to-new-releases)
...
- [支持的语言特性和兼容旧环境（Polyfills）](#supported-language-features-and-polyfills)
- [在编辑器中语法高亮](#syntax-highlighting-in-the-editor)
- [Displaying Lint Output in the Editor](#displaying-lint-output-in-the-editor)
- [在编辑器中调试](#debugging-in-the-editor)
- [改变页面的 `<title>`](#changing-the-page-title)
- [安装依赖](#installing-a-dependency)
- [导入组件](#importing-a-component)
- [代码分割](#code-splitting)
- [添加样式表](#adding-a-stylesheet)
- [后处理 CSS](#post-processing-css)
- [添加CSS预处理器(Sass, Less 等)](#adding-a-css-preprocessor-sass-less-etc)
- [添加图片、字体和文件](#adding-images-fonts-and-files)
- [`public`目录的使用](#using-the-public-folder)
  - [改变HTML](#changing-the-html)
  - [Adding Assets Outside of the Module System](#adding-assets-outside-of-the-module-system)
  - [何时使用`public`目录](#when-to-use-the-public-folder)
- [使用全局变量](#using-global-variables)
- [添加Bootstrap](#adding-bootstrap)
  - [使用自定义主体](#using-a-custom-theme)
- [Adding Flow](#adding-flow)
- [添加自定义环境变量](#adding-custom-environment-variables)
  - [在HTML中引用环境变量](#referencing-environment-variables-in-the-html)
  - [在Shell中添加临时环境变量](#adding-temporary-environment-variables-in-your-shell)
  - [添加开发环境变量到`.env`](#adding-development-environment-variables-in-env)
- [能否使用装饰器?](#can-i-use-decorators)
- [与后台API集成](#integrating-with-an-api-backend)
  - [Node](#node)
  - [Ruby on Rails](#ruby-on-rails)
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - [配置代理后的"Invalid Host Header"错误](#invalid-host-header-errors-after-configuring-proxy)
  - [手工配置代理](#configuring-the-proxy-manually)
- [开发中使用https](#using-https-in-development)
- [在服务器上生成动态`<meta>`标签](#generating-dynamic-meta-tags-on-the-server)
- [预渲染到静态html文件中](#pre-rendering-into-static-html-files)
- [从服务器注入数据到页面](#injecting-data-from-the-server-into-the-page)
- [测试](#running-tests)
  - [文件命名惯例](#filename-conventions)
  - [命令行接口](#command-line-interface)
  - [集成版本控制](#version-control-integration)
  ...
  - [聚焦测试和排除测试](#focusing-and-excluding-tests)
